...
- Direct Watch installation was blocked by a device tunnel timeout. Watch code is unchanged from the installed 4247 build; this fix is in the iPhone notification handler.
