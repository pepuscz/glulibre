...
| `watch.png` | Watch app glucose, trend and recent chart | Build 4238, Apple Watch SE 3 (40mm), `testNowMealAndConnection` |

Captured on 19–20 September 2026. The product UI is the real app; examples are not evidence that banana, yogurt or activity will produce these responses in any person. Files are kept at capture resolution and sized by HTML in the README, without retouching the UI. The Watch screenshot shows the app, not a watch-face complication.
