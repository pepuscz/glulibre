...
Captured on 20 September 2026. The product UI is the real app; examples are not evidence that banana, yogurt or activity will produce these responses in any person. Files are kept at capture resolution and sized by HTML in the README, without retouching the UI.
