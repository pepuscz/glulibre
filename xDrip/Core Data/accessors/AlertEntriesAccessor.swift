            ...
            for alertKindInCases in AlertKind.allCases {
                if alertKind != nil, alertKind != alertKindInCases {
                    ...
                    if !entryFound {
                        ...
                        let newAlertEntry = AlertEntry(isDisabled: !alertKindInCases.enabledByDefault, value: alertKindInCases.defaultAlertValue(), triggerValue: alertKindInCases.defaultAlertTriggerValue(), alertKind: alertKindInCases, start: 0, alertType: alertTypesAccessor.getDefaultAlertType(), nsManagedObjectContext: coreDataManager.mainManagedObjectContext)
